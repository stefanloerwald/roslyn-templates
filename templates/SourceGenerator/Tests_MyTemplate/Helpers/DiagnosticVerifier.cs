...
namespace Tests_MyTemplate.Helpers
{
    public static class DiagnosticVerifier
    {
            ...
            DiagnosticResult[] expectedResults)
        {
            ...
            {
                var diagnosticsOutput = actualResults.Any() ? FormatDiagnostics(actualResults.ToArray()) : "    NONE.";
            ...
            for (var i = 0; i < expectedResults.Length; i++)
            {
                ...
                var squiggledText = GetSquiggledText(actual);
